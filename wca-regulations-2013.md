...
- A7) Recording results:
    ...
    - A7c) The judge and competitor must both sign (or initial) the score sheet to acknowledge the result.
        ...
        - A7c2) Before signing, a competitor is supposed to check the recorded result for correct formatting, completeness and readability. If a result as signed by a competitor is found to be incomplete or unreadable, it will be interpreted the worst reasonable way (e.g. "1:05" will be considered 1:05.99, "1#.65" will be considered 17.65 if # is certainly either a 1 or a 7).
